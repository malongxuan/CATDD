...
class DatasetBase(torchtext.data.Dataset):
    ...
    def __init__(self, fields, src_examples_iter, tgt_examples_iter, knl_examples_iter,
        ...
        if tgt_examples_iter is not None:
            examples_iter = (self._join_dicts(knl, src, tgt) for knl, src, tgt in
                             zip(knl_examples_iter, src_examples_iter, tgt_examples_iter))
        else:
            examples_iter = (self._join_dicts(knl, src) for knl, src in
                             zip(knl_examples_iter, src_examples_iter))
