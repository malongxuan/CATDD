...
def preprocess_opts(parser):
    ...
    group.add('--train_knl', '-train_knl', required=True,
              help="Path to the training knowledge data")
    group.add('--train_src', '-train_src', required=True,
              help="Path to the training source data")
    group.add('--train_tgt', '-train_tgt', required=True,
              help="Path to the training target data")
    group.add('--valid_knl', '-valid_knl', required=True,
              help="Path to the training knowledge data")
    ...
    group.add('--knl_vocab', '-knl_vocab', default="",
              help="""Path to an existing knowledge vocabulary. Format:
                       one word per line.""")
    ...
    group.add('--knl_vocab_size', '-knl_vocab_size', type=int, default=50000,
              help="Size of the knowledge vocabulary")
    ...
    group.add('--knl_words_min_frequency',
              '-knl_words_min_frequency', type=int, default=0)
    ...
    group.add('--knl_seq_length', '-knl_seq_length', type=int, default=200,
              help="Maximum knowledge sequence length")
    group.add('--knl_seq_length_trunc', '-knl_seq_length_trunc',
              type=int, default=0,
              help="Truncate knowledge sequence length.")
...
def translate_opts(parser):
    ...
    group.add('--knl', '-knl', required=True,
              help="""Knowledge sequence to decode (one line per
                           sequence)""")
